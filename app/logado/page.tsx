          ...
          <section>
            ...
            <div>
              <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Clique nesse botão ou na aba acima e você será mandado para a página onde contém as melhores piadas,por que rir é o melhor remédio!</p>
